<<<<<<< HEAD
# this is a readme for a simpleshell project it contenst functions for reading from the stdin then putting it into array then executing the program
=======
# 0x16. C - Simple Shell
...
>>>>>>> d1ae7b260ed84ffe56a3e4c918c04e9af78d61e3
